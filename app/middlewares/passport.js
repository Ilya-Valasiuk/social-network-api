...
passport.use(new VKontakteStrategy({
  ...
  callbackURL: process.env.NODE_ENV === 'production' ? 'https://social-network-api-test.herokuapp.com/api/auth/vkontakte/callback' : 'http://localhost:3000/api/auth/vkontakte/callback',
